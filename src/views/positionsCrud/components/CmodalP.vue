<template>
  <Dialog v-model:visible="visible" header="Crear posicion" :modal="true" :closable="true" :style="{ width: '600px'}" >
    <Form @submit="submit" :validation-schema="schema" class="">
  <div class=" grid gap 10">


    <div class="flex flex-col w-full max-w-md mx-auto">
      <label for="na_position" class="text-left">nombre posicion</label>
      <Field name="na_position" v-slot="{ field }">
        <InputText v-bind="field" id="na_position" placeholder="Ingrese nombre" class="w-full" />
      </Field>
